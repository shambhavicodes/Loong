...
# Run Loong evaluation for hybrid distilled model using GPT-4 as judge
# This script runs the complete evaluation pipeline with GPT-4 evaluation
...
JUDGE_MODEL="gpt4"  # Using GPT-4 as judge
OUTPUT_DIR="output/hybrid_evaluation_gpt4"
DEBUG_NUM=10  # Set to -1 for full evaluation

echo "=== Hybrid Model Loong Evaluation with GPT-4 Judge ==="
echo "Model: $MODEL_NAME"
echo "Teacher: $TEACHER_MODEL"
echo "Judge: $JUDGE_MODEL (GPT-4)"
...
# Step 3: Evaluate hybrid model responses with GPT-4
echo "=== Step 3: Evaluate Hybrid Model responses with GPT-4 ==="
...
# Step 4: Evaluate teacher model responses with GPT-4
echo "=== Step 4: Evaluate Teacher Model responses with GPT-4 ==="
python src/step3_model_evaluate.py \
    --model "$TEACHER_MODEL" \
    --eval_model "$JUDGE_MODEL" \
    --model_config_dir config/models \
...
echo "=== Step 6: Results ==="
echo "Hybrid Model Metrics (GPT-4 evaluated):"
cat "$OUTPUT_DIR/hybrid_metrics.json"
echo ""
echo "Teacher Model Metrics (GPT-4 evaluated):"
cat "$OUTPUT_DIR/teacher_metrics.json"

echo ""
echo "=== Evaluation Complete ==="
echo "Results saved in: $OUTPUT_DIR/"
echo "GPT-4 evaluation provides high-quality scoring for both models"
