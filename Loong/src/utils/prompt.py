...
def get_content(args, item, doc_name, idx):
    ...
    if doc_type == 'financial':
        ...
        try:
            ...
            doc = f"Error loading document: {doc_name}\n\n"
...
Now, start your evaluation:'''
    ...
    for line in lines:
        ...
        # Use the actual processed prompt from generation step instead of reconstructing it
        if 'prompt' in line:
            question = line['prompt']
        else:
            # Fallback to template-based approach for backward compatibility
